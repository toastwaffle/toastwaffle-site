    ...
    class RecentLinks extends Modules {
        ...
        public function settings_nav($navs)
		{
            ...
            public function admin_recent_links_settings($admin)
            {
                ...
                if (($config->set("recent_links_title", $_POST['recent_links_title'])) && ($config->set("recent_links_display_count", $_POST['recent_links_display_count'])) && ($config->set("recent_links_reverse_order", $reverse)) && ($config->set("show_recent_links", $showlinks)) && ($config->set("recent_links", $links, $true))) {
